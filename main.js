class School {
  ...
  quickFacts() {
    console.log(
      `${this.name} educates ${this._numberOfStudents} students at the ${this._level} school level.`
    );
  }
...
//checks to see everything is working as expected with the parent class
// const school1 = new School("immanuel", 10, 901);

// console.log(school1.name);
// console.log(school1.level);
// console.log(school1._numberOfStudents);
// school1.numberOfStudents = 800;
